...
<div id="carouselExampleInterval" class="carousel slide overflow-hidden max-carousel-vh-lg " data-bs-ride="carousel">
    <div class="hero-bg px-3 px-sm-4 px-md-5" >
        <span class="hero-text">
        For The Better <br>Gaming Experience.
        </span>
    </div>
    <div class="carousel-inner">
        <div class="carousel-item overflow-hidden active" data-bs-interval="10000">
            <img src="img/slider1.jpg" class="img-responsive d-block on-w-lg-100" alt="...">
        </div>
        <div class="carousel-item overflow-hidden" data-bs-interval="2000">
            <img src="img/slider2.webp" class="img-responsive d-block on-w-lg-100" alt="...">
        </div>
        <div class="carousel-item overflow-hidden">
            <img src="img/slider3.jpg" class="img-responsive d-block on-w-lg-100" alt="...">
        </div>
    </div>
...
{{-- about us --}}
<section class="h-100 w-100 pt-0 pt-lg-0 pb-5 px-lg-5" style="box-sizing: border-box; background-color: #00000095;">
    <div class="content-3-4 container-xxl mx-auto position-relative" style="font-family: 'Poppins', sans-serif;">
        <div class="d-flex flex-row flex-column align-items-center mb-0">
            <h2 class="title-text text-white mb-0 mb-lg-4">About Us</h2>
        </div>
        <div class="d-flex flex-lg-row flex-column align-items-center">
            <!-- Left Column -->
            <div class="img-hero py-4 text-center justify-content-center d-flex mb-4 mb-lg-0">
                <img id="hero" class="img-fluid" src="img/about.jpg" style="height: 25rem;">
            </div>

            <!-- Right Column -->
            <div
                class="right-column d-flex flex-column align-items-lg-start align-items-between text-lg-start text-center">
                <ul class="px-3 py-0 m-0">
                    <li class="list-unstyled" style="margin-bottom: 2rem;">
                        <h4
                            class="title-caption mb-2 text-white d-flex flex-row align-items-center justify-content-start">
                            <span class="circle me-3 mb-0 mb-sm-2 d-flex align-items-center justify-content-center">
                                1
                            </span>
                            Vision
                        </h4>
                        <p class="text-caption lh-base" style="text-align: left;">
                            Support every gamer to develop a better in terms of esports and creating a healthy gamer
                            environment
                        </p>
                    </li>
                    <li class="list-unstyled" style="margin-bottom: 2rem;">
...
{{-- another section --}}
<section class="h-100 w-100 py-2 py-lg-5" style="box-sizing: border-box; background-color: #ffffff">
    <div class="content-2-2 container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif">
        <div class="text-center title-text mb-2 pt-5">
        ...
        <div class="grid-padding text-center">
            <div class="row">
                ...
                <div class="col-lg-4 column">
                    <div class="icon">
                        <img src="/img/chibi3.webp" style="height:200px" alt="" />
                    </div>
...
<section class="h-100 w-100" style="box-sizing: border-box; background-color: #000000">
    ...
    <div class="footer-2-4 container-xxl mx-auto position-relative p-0" style="font-family: 'Poppins', sans-serif">
        <div class="list-footer py-5">
            <div class="row gap-lg-0 gap-sm-0 gap-3">
